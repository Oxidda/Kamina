...
using Kamina.Logic.Core.Message;
using Kamina.Logic.Core.WordResponse;
using Microsoft.Extensions.DependencyInjection;

namespace Kamina.Logic.Core
{
    public class CommandHandler
    {
        ...
        public async Task Start()
        {
            try
            {
                ...
                await commands.AddModulesAsync(Assembly.Load(new AssemblyName("Kamina.Logic.Core")));
